...
<div class="card">
  ...
  <MenuBar :model="items" class="flex bg-surface-0">
            ...
            <template  #item="{ item, props, hasSubmenu, root }">
                  ...
                  <a  v-ripple class="flex align-items-center md:justify-content-center" v-bind="props.action">
            ...
            <template #end>
                <div class="flex flex-1 align-items-center gap-4" >
                 
                    <router-link to="/products/cart" >
                        <!-- <Button label="Contact" plain text /> -->
                        <b>
                          Contact
                        </b>
                    </router-link>
                    <router-link to="/products/cart" class="surface-0 border-round">
                        <Button type="button" label="cart" icon="pi pi-shopping-cart" :badge="totalCartItems || '0'" badgeClass="p-badge-danger " outlined />
                    </router-link>
   ...
   <!-- <div id="nav-bar">
    ...
    <router-link to="/products/cart" id="cart-link">
